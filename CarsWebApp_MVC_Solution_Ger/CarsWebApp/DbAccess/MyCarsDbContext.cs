    ...
    public partial class MyCarsDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Car>().HasData(
                new Car { Id = 1, Brand = "Chevrolet", Type = "Camaro", Price = 38000, Year = 2022, CarColorId = 5 },
                new Car { Id = 2, Brand = "Hyundai", Type = "Elantra", Price = 19000, Year = 2022, CarColorId = 3 },
                new Car { Id = 3, Brand = "Volkswagen", Type = "Passat", Price = 21500, Year = 2022, CarColorId = 3 },
                new Car { Id = 4, Brand = "Chevrolet", Type = "Equinox", Price = 21000, Year = 2022, CarColorId = 4 },
                new Car { Id = 5, Brand = "Volkswagen", Type = "Jetta", Price = 19500, Year = 2022, CarColorId = 2 },
                new Car { Id = 6, Brand = "Chevrolet", Type = "Malibu", Price = 20000, Year = 2022, CarColorId = 1 },
                new Car { Id = 7, Brand = "Hyundai", Type = "Santa Fe", Price = 24000, Year = 2022, CarColorId = 4 },
                new Car { Id = 8, Brand = "Volkswagen", Type = "Tiguan", Price = 21600, Year = 2022, CarColorId = 5 },
                new Car { Id = 9, Brand = "Chevrolet", Type = "Trailblazer", Price = 20000, Year = 2022, CarColorId = 3 }
            );
